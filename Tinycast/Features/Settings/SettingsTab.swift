enum SettingsTab: CaseIterable, Identifiable {
    case general, applications, systemSettings, systemActions, commands, quicklinks, appleShortcuts,
        fallbacks, ai, quickActions, fileSearch, iCloudTabs, notes, snippets, navigation,
        windowManagement, clipboard, emoji, calendar, extensions, permissions, backup, about
    ...
    var title: String {
        ...
        case .iCloudTabs: return "iCloud Tabs"
    ...
    var systemImage: String {
        ...
        case .appleShortcuts: return "square.stack.3d.up"
...
enum SettingsSection: CaseIterable, Identifiable {
    ...
    var tabs: [SettingsTab] {
        ...
        case .features:
            return [
                .ai, .quickActions, .fileSearch, .iCloudTabs, .notes, .snippets, .navigation,
