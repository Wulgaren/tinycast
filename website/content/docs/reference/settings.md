...
There are 23 panes in four groups.
...
| Apple Shortcuts | [Apple Shortcuts](/docs/launcher/apple-shortcuts) switch and a row per shortcut                                 |
...
| iCloud Tabs                                           | Enable iCloud Tabs                | Command, Full Disk Access                                                                                                                                                                                                                     |
...
| [Clipboard](/docs/features/clipboard)                 | Enable Clipboard History (**On**) | Clipboard commands, Open with ⌘4 in palette (**Off**), Keep history for (**3 Months**), Search text in images and PDFs (**Off**), Default action (**Paste**), Disabled Applications, Clear history                                         |
