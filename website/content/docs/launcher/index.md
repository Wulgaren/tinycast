...
quicklinks, Apple Shortcuts, snippets, system actions, window commands and layouts, custom commands,
Quick Actions, extension commands and upcoming meetings.
...
Meetings → Applications → System Settings → Extensions → Quicklinks → Apple Shortcuts → Snippets →
System Actions → Window Layouts → Window Management → Custom Commands → Quick Actions → Commands
