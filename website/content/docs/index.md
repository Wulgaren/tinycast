...
It stays under 100 MB of memory, because it is SwiftUI and AppKit with zero third-party
dependencies. There is no Electron, no account, no sign-in and no telemetry.
